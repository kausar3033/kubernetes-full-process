...
#### FOR EASY Installation we have sh file. Just clone the git repo in master node by run the command
     ...
     git clone https://github.com/kausar3033/kubernetes-full-process.git&&cd kubernetes/&&chmod +x master.sh&&./master.sh
  
#### FOR EASY Installation we have sh file. Just clone the git repo in worker node by run the command
  
    git clone https://github.com/kausar3033/kubernetes-full-process.git&&cd kubernetes/&&chmod +x worker.sh&&./worker.sh
